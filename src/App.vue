  ...
  <main class="app-shell">
    <nav class="app-nav" :aria-label="t('nav.label')">
      ...
      <div class="nav-center">
        <button class="nav-calculator active" type="button" aria-current="page">
          {{ t('nav.alloys') }}
        </button>
      </div>
    ...
    <section class="toolbar">
      <div>
        <p class="eyebrow">TerraFirmaCraft</p>
        <h1>{{ t('app.title') }}</h1>
      </div>
    </section>
    ...
    <section class="mix-panel">
      ...
      >
        ...
        <div class="combos">
          ...
          <span v-if="state.combinations.length === 0" class="empty-combo">{{ t('recipe.noMatchingCombinations') }}</span>
